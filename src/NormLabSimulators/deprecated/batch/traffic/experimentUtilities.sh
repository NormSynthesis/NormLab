...
function createParamsFile()
{
	...
	echo "  <parameter name='NormsSpecThresholdEpsilon'    	value='0.2'				type='constant' constant_type='number' />" >> $fileName
	echo "  <parameter name='NormsMinEvaluations'	     	value='50'				type='constant' constant_type='number' />" >> $fileName

	echo "  <parameter name='NormSynthesisExample'	     	value='0'				type='constant' constant_type='number' />" >> $fileName
	echo "  <parameter name='NormSynthesisStrategy'		value='5'				type='constant' constant_type='number' />" >> $fileName
	...
	echo "  <parameter name='NormGenerationReactive'        value='true'                            type='constant' constant_type='boolean' />" >> $fileName
	echo "  <parameter name='NormsMinEvaluationsToClassify' value='10'                            	type='constant' constant_type='number' />" >> $fileName
	echo "  <parameter name='NormGroupsMinEvaluationsToClassify' value='10'                        type='constant' constant_type='number' />" >> $fileName

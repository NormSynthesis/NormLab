 ...
 * 
 */
public class ConfigureAgentWindow extends JFrame implements ActionListener {
	 ...
	 */
	private ArrayList<OnlineCommunityUser> agents = new ArrayList<OnlineCommunityUser>();
...
//		new PopulationXMLManager(newPopulationName.getText(), agents);
	}
	 ...
	 * 
	 */
	public ArrayList<OnlineCommunityUser> getAgents() {
		return agents;
	}
}

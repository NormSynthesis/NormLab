 ...
 *
 */
public class OnlineCommunityUserContext implements EnvironmentAgentContext {

	private long agentId;
	private int section;
	private int contentType;
	
	private OnlineCommunityUser agent;
	 ...
	 */
	public OnlineCommunityUserContext(long agentId, int section, int contentType,
	 ...
	 */
	public OnlineCommunityUserContext(OnlineCommunityUser agent, 
		...
		this.description = this.factFactory.generatePredicates(this);
	}
	...
	public boolean equals(EnvironmentAgentContext otherContext){
		OnlineCommunityUserContext context = (OnlineCommunityUserContext)otherContext;

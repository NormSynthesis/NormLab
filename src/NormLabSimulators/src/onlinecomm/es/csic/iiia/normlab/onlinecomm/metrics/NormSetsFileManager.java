...
public class NormSetsFileManager {
	...
	public void load() {
		...
		if(this.convergence){
			finalNormSetsFilename = ocSettings.getOutputDataPath() + 
					"/Converged" + ocSettings.getFinalNormSetsFilename();
			finalNormSetsPlotFilename = ocSettings.getOutputDataPath() +
					"/Converged" + ocSettings.getFinalNormSetsFilename()
					+ ".plot";
		}
		else {
			finalNormSetsFilename = ocSettings.getOutputDataPath() + 
					"/NotConverged" + ocSettings.getFinalNormSetsFilename();
			finalNormSetsPlotFilename = ocSettings.getOutputDataPath() + 
					"/NotConverged" + ocSettings.getFinalNormSetsFilename()
					+ ".plot";
		}

...
public class ContextData {
	 ...
	 */
	public ContextData(int maxAgents, long contentsQueueSize, Random random){
...
//		allContents = Collections.synchronizedList(new ArrayList<IContent>());
		...
		serie = new XYSeries("Non regulated complaints", true, true);
		serie2 = new XYSeries("Regulated complaints", true, true);
		serie3 = new XYSeries("Current complaints", true, true);

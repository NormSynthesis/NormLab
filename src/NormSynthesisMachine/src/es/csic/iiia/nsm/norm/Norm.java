...
public class Norm implements Comparable<Norm>, NetworkNode {
	...
	private Goal goal; // to achieve which goal has the norm been created?
	...
	public Norm(SetOfPredicatesWithTerms precondition, NormModality modality, 
			EnvironmentAgentAction action, Goal goal) {
	...
	/**
	 * Returns the goal that is aimed at achieving 
	 * with the creation of this norm
	 * @return
	 */
	public Goal getGoal() {
		return this.goal;

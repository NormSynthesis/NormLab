...
public class NormSynthesisNetwork<T> {
	...
	protected double normsDefaultUtility;
	...
	public void add(T node) {
		if(!this.graph.containsVertex(node)) {
			...
			List<EvaluationCriteria> dims = this.nsm.getNormEvaluationDimensions();
	 ...
	 */
	public void setScore(T node, EvaluationCriteria dim, Goal goal, double score) {

...
import es.csic.iiia.nsm.norm.refinement.generalisation.GeneralisationReasoner;
...
public class DefaultNormSynthesisMetrics implements NormSynthesisMetrics {
	...
	protected List<EvaluationCriteria> dimensions;
...
//		}	
	...
	private void updateNormativeSystemMetrics() {
		...
		for(EvaluationCriteria dim : this.dimensions) {

...
public interface DomainFunctions {
	 ...
	 * using the {@code IRON} norm synthesis strategy. Otherwise, 
	 * there is no need that you implement this method, which should
	...
	//---------------------------------------------------------------------------
	// Conflict solving functions
	//---------------------------------------------------------------------------
	
	/**
	 * Returns a list of the id's of those agents that are considered as responsible
	 * for a given conflict. For instance, in a road traffic scenario, if two cars
	 * with id's 1 and 2 have collided (i.e., a conflict) and car 1 is considered 
	 * to be responsible for the collision, then this method should return a list
	 * containing the id of car 1. 
	 * 
	 * @param conflict the conflict to solve
	 * 
	 * @return a list of the id's of those agents that are considered as responsible
	 * for the conflict
	 */
